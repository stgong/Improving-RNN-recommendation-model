...
def gen_mini_batch(sequence_generator, batch_size = 3, iter=False, test=False):
...
dataset = DataHandler(dirname="/Users/xun/Documents/Thesis/Improving-RNN-recommendation-model/ks-3m/")
...
result = model.fit_generator(generator = train_generator, steps_per_epoch = 25300, epochs= 5,
